    ...
    <div id="categories">
     ...
     <div id="customer">
        ...
        <div id="search">
            ...
            <div>
                      <input style="border:none"id="searchPd" type="text" value="" placeholder="Search on Nykaa " >
            </div>
...
<div id="bottom">
    ...
    <div>Makeup</div>
    <div>Skin</div>
    <div id="hairanchor"><a href="./hair.html">Hair</a></div>
    <div>Appliances</div>
    ...
    <div>Fragrance</div>
    <div>LUXE</div>
    <div id="offerid"><a href="./offer.html">Offer</a></div>
</div>`
